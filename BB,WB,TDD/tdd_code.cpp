...
void PriorityQueue::Insert(int value)
{
    ...
    else
    {
        if (item->pPrev == NULL && item->pNext == NULL)
        {
            ...
            {
                elmt->pNext = NULL;
                elmt->pPrev = item_first;
                elmt->value = value;
                item_first->pNext = elmt;
            }
            else
            {
                elmt->pNext = item;
        ...
        else if (item->pNext != NULL)
        {
            
            for (Element_t* item = GetHead(); value > item->value; item = item->pNext)
                ;
                       
            if (item->pNext != NULL && item->pPrev != NULL)
            {
                elmt->pPrev = item->pNext->pPrev;
                elmt->pNext = item->pPrev->pNext;
                item->pNext->pPrev = elmt;
                item->pPrev->pNext = elmt;
                item = elmt;
            }
